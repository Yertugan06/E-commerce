...
| Checkout Success Rate | >= 99.5% | 7-day rolling | < 99.5% for 5m | FastAPI Middleware (http_requests_total) |
...
| Checkout Success Rate | Count of HTTP 200/201 responses for POST /checkout / Total POST /checkout requests | FastAPI Middleware (http_requests_total) |
